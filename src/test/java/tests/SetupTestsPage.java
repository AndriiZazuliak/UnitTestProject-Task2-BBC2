...
public class SetupTestsPage {
    ...
    public DatesGamesPage getDatesGamesPage(){
        return new DatesGamesPage(getDriver());
    }
    public MonthsGamesPage getMonthsGamesPage() {
        return new MonthsGamesPage(getDriver());
    }
